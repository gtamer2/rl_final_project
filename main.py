...
from src.modules.predict.predict import perform_rlhf_ppo_prediction
import numpy as np
...
def main(model_name,dataset_size,epochs,batch_size,lr,seed,mode,model_save_path,rewards_save_path):
    ...
    if mode == 'train':
        ...
        print("Prediction")
        perform_rlhf_ppo_prediction(model_name=model_name,dataset_size=dataset_size,epochs=epochs,
                                  batch_size=batch_size,lr=lr,seed=seed,model_save_path=model_save_path,
                                  rewards_save_path=rewards_save_path)
